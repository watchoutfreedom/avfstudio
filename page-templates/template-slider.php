...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function randomizeInitialLayout(){
        ...
        setTimeout(() => {
            const brandCardData = { type: 'brand', title: 'AVF', slogan: 'Play Creation Card.', content: `<div class="brand-content"><p>In a marketplace of echoes, a powerful, foundational concept is the only true way to stand out. Our studio is a unique collective where every person gives the best. Philosophers probe the 'why', architects design the structure, and artists give it a soul.</p><a href="#" id="brand-contact-link">+ request your card</a></div><div class="brand-card-footer"><h1>AVF</h1><h2>Your Unfair Creative Advantage.</h2></div>` };
